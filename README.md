...
![월간 근무표 화면](docs/images/monthly-schedule.png)
...
**백업 파일 복원**은 선택한 SQLite 백업의 무결성을 검사한 뒤 현재 데이터를 교체합니다. 복원 직전의 데이터는 자동으로 `seven-work-manager-pre-restore-날짜.db` 파일에 별도 보관하므로, 잘못된 파일을 선택했을 때도 되돌릴 수 있습니다.
